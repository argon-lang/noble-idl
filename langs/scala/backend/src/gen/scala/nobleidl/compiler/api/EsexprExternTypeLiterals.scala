...
final case class EsexprExternTypeLiterals(
  ...
  allowBool: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
  @_root_.esexpr.keyword("allow-int")
  allowInt: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
  ...
  allowStr: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
  @_root_.esexpr.keyword("allow-binary")
  allowBinary: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
  @_root_.esexpr.keyword("allow-float32")
  allowFloat32: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
  @_root_.esexpr.keyword("allow-float64")
  allowFloat64: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
  @_root_.esexpr.keyword("allow-null")
  allowNull: _root_.nobleidl.core.Bool = _root_.nobleidl.core.Bool.fromBool(false),
