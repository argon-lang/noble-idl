...
cp noble-idl/runtime/nobleidl-core.nidl java/runtime/build/resources/main/dev/argon/nobleidl/runtime/

mkdir -p java/example/src/main/resources/dev/argon/nobleidl/example/
cp noble-idl/runtime/nobleidl-core.nidl java/example/src/main/resources/dev/argon/nobleidl/example/
