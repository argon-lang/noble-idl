...
public record SimpleEnumDefinition(
	...
	java.util.List<dev.argon.nobleidl.compiler.api.SimpleEnumCase> cases,
	@dev.argon.esexpr.Keyword("esexpr-options")
	@dev.argon.esexpr.OptionalValue
	java.util.Optional<dev.argon.nobleidl.compiler.api.EsexprSimpleEnumOptions> esexprOptions
) {
